...
set :repo_url, 'git@github.com:fimesfi/REPO.git'

# Folbert-addition: name of the dir where theme is placed. Not the entire path.
set :theme_directory_name, 'THEME_FOLDERNAME'
...
set :deploy_to, -> { "/home/CPANEL_USER/staging.DOMAIN.fi" }
...
set :tmp_dir, "/home/CPANEL_USER/tmp"
